				...
				<c:if test="${not empty cart_list}">
               	...
               	<c:forEach var="item" items="${cart_list}" step ="1">
                    ...
                    <tr class="cart__list__detail">
                        ...
                        <td>
                            <p>상품 번호 : ${item.product_num}</p>
                            <p>상품 이름 : ${item.product_name}</p>
                            
                            <sapn class="price">${item.price}</sapn><span
                                style="text-decoration: line-through; color: lightgray;">119,000</span>
                        </td>
                        <td class="cart__list__option">
                            <p>size : ${item.p_size} / 주문 수량 : ${item.amount}</p>
                            ...
                            <div class="ml-3200">
                             ...
                             <select id="size_opt" name="size_opt" class="form-select form-select-sm w-100 col-3">
                        ...
                        <td><span class="price">${item.price}</span><br>
                        
                            <button class="cart__list__orderbtn"><a href="${ctxPath}/orderRegister.do?user_id=${item.user_id}&product_num=${item.product_num}&amount=${item.amount}&product_name=${item.product_name}&price=${item.price}&size_opt=${item.p_size}&imagePath=${item.imagePath}">주문하기</a></button>
