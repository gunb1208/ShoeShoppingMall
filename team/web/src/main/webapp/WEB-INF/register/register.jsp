                    ...
                    <div class="bg-opacity-10 border border-2 border-start-0 border-end-0">
                      ...
                      <div class="mt-5 mb-5 row justify-content-start">
                        ...
                        <div class="row d-flex m-2 mb-3">
                          ...
                          <input type="text" class="col-8 underline p-1" id="user_id" name="user_id" placeholder="아이디를 입력해 주세요" style="font-size: 1rem;">
                          <div class="col-1"></div>
                        </div>
                        ...
                        <div class="row d-flex m-2 mb-3">
                          ...
                          <input type="text" class="col-8 underline p-1" placeholder="비밀번호를 재입력해 주세요" style="font-size: 1rem;">
                          <div class="col-1"></div> 
                        </div>
        ...
        <div class="row d-flex m-5">
          ...
          <div class="row col-6 mb-5">
            <div class="d-flex justify-content-center">
              ...
              <button type="submit" class="btn btn-lg btn-dark m-1 rounded-0" id="next" style="width: 20%; height: 90%;">회원가입</button>
           </div>
          </div>
          <div class="col-3"></div>
      </div>    
