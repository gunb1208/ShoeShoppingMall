      ...
      <div class="main mt-5 mb-5">
        ...
        <div class="row d-flex">
            ...
            <div class="col-8 row justify-content-center">
                <h3 class="mb-5"><strong>주문서작성/결제</strong></h3>
            
                <h5 class="mb-3"><strong>주문리스트</strong></h5>
                ...
                <div class="p-2 bg-opacity-10 border border-2 border-start-0 border-end-0">
                    <div class="row d-flex">
                        <div class="col-2 text-center m-auto">
                            ...
                            <img alt="" width="150px" src="/web/download/asd?imageFileName=${order_info.imagePath}">
                        ...
                        <div class="col-5 p-2">
                        상품번호
                        	<input type="text" id="product_num"  name = "product_num" value = "${order_info.product_num}" class="form-control" readonly>
                            <p><strong>뉴발란스</strong></p>
                            <input type="text" id="product_name" name = "product_name" value ="${order_info.product_name}" class="form-control" readonly>
                            
                             <br>
                             
                         사이즈  <input type="text" id="p_size" name="p_size" value ="${order_info.p_size}" class="form-control" readonly>
                         수량  <input type="text"  id="amount" name="amount" value ="${order_info.amount}" class="form-control" readonly>
                         
                        </div>
                        <div class="col-3 text-center m-auto">
                            <p style="font-size: 0.8em;">적립포인트</p>
                            <p style="color: red;">100p</p>
                        </div>
                        <div class="col-2 text-center m-auto">
                            <input type="text" id="price" name="price" value ="${order_info.price}"class="form-control" readonly>
                        </div>
                    </div>
                    ...
                    <div class="bg-opacity-10 border border-2 border-start-0 border-end-0">
                      ...
                      <div class="mt-5 mb-5 row justify-content-start">
                        ...
                        <div class="row d-flex m-2">
                           ...
                           <input type="text"  id="address" name="address" class="col-3 border">&nbsp;
