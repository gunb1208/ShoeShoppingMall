                    ...
                    <div class="">
                        <table class="table table-borderless">
                            <thead class="table-light">
                              <tr>
                                <th class="col-1 text-center">주문번호</th>
                            ...
                            <tbody>
                              <tr>
                                <td class="col-1 text-center">${order_info.order_num}</td>
                                <td class="col-2" onclick="productView()" style="cursor: pointer">
                                  <a href="${ctxPath}/productView.do?product_name=${order.product_name}">${order.product_name}</a>
                                </td>
                                <td class="col-3">${order.product_opt}사이즈</td>
                                <td class="col-1 text-center">${order_info.amount}</td>
                                <td class="col-2 text-center">${product_info.point} 적립</td>
                                <td class="col-1 text-center">${product_info.price} 원</td>
                  ...
                  <div>
                    <div class="mt-5 mb-5 row justify-content-start">
                      ...
                      <div class="row d-flex m-2">
                        ...
                        <input type="text" class="col-8 delivery_form" value="${product_info.price}원" readonly>
                      </div>
