...
${order_info}
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-danger">주문 수정</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                        <div class="main mt-5">
								        <div class="container">
								        <form action="${ctxPath}/admin_sellingUpdate.do" method="get" class="mb-5">
	...
	<script type="text/javascript">
	    ...
	    function admin_sellingUpdate(){
			location.href="${ctxPath}/admin_sellingUpdate.do"
		}
