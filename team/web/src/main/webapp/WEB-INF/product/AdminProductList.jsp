                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-danger">상품 목록</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
								          ...
								          <div class="w-100 m-auto mt-5">
								            <table class="table">
								              <thead class="table-light">
								                ...
								                <tr>
								                  <th scope="col" style="width: 17.5%">상품번호</th>
								                  <th scope="col" style="width: 47.5%">상품명</th>
								                  <th scope="col" style="width: 10%">브랜드</th>
								                  <th scope="col" style="width: 16%">가격</th>
								                </tr>
								            ...
								            <c:forEach var ="item" items="${product_info}" step="1">
								            
								              <tr>
								                  <th scope="row">${item.product_num}</th>
								                  <td  style="cursor: pointer">
								                    <a href="${ctxPath}/admin_productView.do?product_name=${item.product_name}">${item.product_name}</a>
								                  </td>
								                  <td id="center">${item.product_brand}</td>
								                  <td id="center">${item.price}원</td>
								                </tr>
...
${totSection}
                    ...
                    <ul class="pagination">
                       	<c:forEach var="page" begin="1" end="${lastPage}" step="1" >
		                     <!--  section 2이상이고 1page이면 이전 버튼 활성화 -->	
	                       	 <c:if test="${section > 1 && page==1 }">
		                      	<li class="page-item ">
		                        	<a class="page-link" href="${ctxPath}/admin_productList.do?pageBlock=${section-1}&pageNum=1">이전</a>
		                     	</li>
		                     </c:if>  
		                     ...
		                     <c:choose>
	   	                    	<c:when test="${page==pageNum}">
	   	                    	 <li class="page-item  disabled" aria-current="page">
			                      	<a class="page-link" href="${ctxPath}/admin_productList.do?pageBlock=${section}&pageNum=${page}">${(section-1)*10 + page}</a>
			                     </li>
	   	                    	</c:when>
	   	                    	<c:otherwise>
	   	                    	 <li class="page-item ">
                        ...
                        <!--  다음 버튼 : 현재 section번호가 전체 section 번호 보다 작은 경우만 표시-->
	                      ...
	                      <li class="page-item">
	                        <a class="page-link" href="${ctxPath}/admin_productList.do?pageBlock=${section+1}&pageNum=1">다음</a>
	                      </li>
                      	</c:if>
                    </ul>
                </nav>
	...
	<script type="text/javascript">
		...
		function admin_productView(){
			location.href="${ctxPath}/admin_productView.do"
		}
		function admin_productRegister(){
			location.href="${ctxPath}/admin_productRegister.do"
		}
	</script>
