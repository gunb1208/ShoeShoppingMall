		...
		<div class="productSearchList mt-5 mb-5">
	      ...
	      <div class="row d-flex">
	        ...
	        <div class="col-8">
	          ...
	          <h2 class="text-center mt-3 mb-5"><strong>ADIDAS</strong></h2>
	          <hr class="border-2">
	
	          <div class="mt-5 mb-5 row d-flex align-content-center flex-wrap">
	            <c:forEach var="item" items="${ads_list}">
	            ...
	            <nav aria-label="...">
                    <ul class="pagination">
                       	<c:forEach var="page" begin="1" end="${lastPage}" step="1" >
		                     <!--  section 2이상이고 1page이면 이전 버튼 활성화 -->	
	                       	 <c:if test="${section > 1 && page==1 }">
		                      	<li class="page-item ">
		                        	<a class="page-link" href="${ctxPath}/productList_adidas.do?pageBlock=${section-1}&pageNum=1">이전</a>
		                     	</li>
		                     </c:if>  
		                     ...
		                     <c:choose>
	   	                    	<c:when test="${page==pageNum}">
	   	                    	 <li class="page-item  disabled" aria-current="page">
			                      	<a class="page-link" href="${ctxPath}/productList_adidas.do?pageBlock=${section}&pageNum=${page}">${(section-1)*10 + page}</a>
			                     </li>
	   	                    	</c:when>
	   	                    	<c:otherwise>
	   	                    	 <li class="page-item ">
                        ...
                        <!--  다음 버튼 : 현재 section번호가 전체 section 번호 보다 작은 경우만 표시-->
	                      ...
	                      <li class="page-item">
	                        <a class="page-link" href="${ctxPath}/productList_adidas.do?pageBlock=${section+1}&pageNum=1">다음</a>
	                      </li>
                      	</c:if>
                    </ul>
                </nav>
