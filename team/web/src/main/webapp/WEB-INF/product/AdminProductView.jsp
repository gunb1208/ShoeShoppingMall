...
${product_info}
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-danger">상품 정보</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                        <div class="main mt-5">
								          ...
								          <div class="w-75 m-auto">
								              ...
								              <div class="col-sm-10">
									                <input
									                  ...
									                  class="form-control border rounded-1 p-2"
									                  id="product_num"
									                  value="${product_info.product_num}"
									                />
									              </div>
									            </div>
								            <div class="mb-3 row">
								              <label for="title" class="col-sm-2 col-form-label">브랜드</label>
								              <div class="col-sm-10">
								                <input
								                  type="text"
								                  name="product_brand"
								                  ...
								                  class="form-control border rounded-1 p-2"
								                  id="product_brand"
								                  value="${product_info.product_brand}"
								                />
								              </div>
								            </div>
								            <div class="mb-3 row">
								            ...
								            <div class="mb-3 row">
								              <label for="title" class="col-sm-2 col-form-label">성별</label>
								              <div class="col-sm-10">
								                <input
								                  type="text"
								                  name="gender"
								            ...
								            <div class="mb-3 row">
								              ...
								              <div class="col-sm-10">
								                <textarea
								                  ...
								                  id="description"
								                  rows="10"
								                >${product_info.description }</textarea
								                >
								              </div>
								            </div>
								            <div class="mb-5 row">
								            ...
								            <div class="mb-3 row">
								              <label for="title" class="col-sm-2 col-form-label">재고</label>
								              <div class="col-sm-10">
								                <input
								                  type="text"
								                  name="in_count"
								                  ...
								                  class="form-control border rounded-1 p-2"
								                  id="in_count"
								                  value="${product_info.in_count}"
								                />
								              </div>
								            </div>
								            
								             <div class="mb-3 row">
								              <label for="title" class="col-sm-2 col-form-label">적립 포인트</label>
								              <div class="col-sm-10">
								                <input
								                  type="text"
								                  name="point"
	...
	<script type="text/javascript">
		...
		function admin_productModify(){
			location.href="${ctxPath}/admin_productModify.do"
		}
		function admin_productDelete(){
			location.href="${ctxPath}/admin_productDelete.do"
		}
	</script>
