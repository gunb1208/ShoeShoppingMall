      ...
      <div class="productView mt-5">
        ...
        <div class="row d-flex">
            ...
            <div class="col-4 row justify-content-center">
                ...
                <div class="row d-flex mt-3 w-75">
                  <div class="col-3">
                    <img alt="" width="100px" src="/web/download/asd?imageFileName=${product_info.imagePath}">
                  </div>
                  <div class="col-3">
                  <img alt="" width="100px" src="/web/download/asd?imageFileName=${product_info.imagePath}">
                  </div>
            ...
            <form action="${ctxPath}/orderRegister.do">
                <a href="#">${product_info.product_brand}</a>
                <br>
                ...
                <div class="d-block d-flex justify-content-between align-items-center">
                  <h5 class="mt-1 mb-1">총 결제금액</h5>
                  <input type="text" name="price" id="price" value="${product_info.price}" class="all_price border-0 text-end" style="font-size: 1.8em;" readonly>
                	<h3>원</h3>
                </div>
        ...
        <div class="mt-5" id="review">
          <div class="row d-flex">
              ...
              <div class="col-8">
                ...
                <select class="form-select form-select-sm col-3" style="width: 8%;">
               ...
               <div class="m-3">
                ...
                <div class="mt-3">
                  <input type="text" value="${item.user_id}" class="review_text" style="font-size: 0.8em; color: gray;" readonly>
        ...
        <div class="mt-5 mb-5">
          <div class="row d-flex">
            ...
            <div class="col-8 m-1">
              ...
              <div class="mb-3 mt-3">
                <label style="color: gray; font-size: 0.9em;">사진첨부</label>
                <input type="file" class="form-control form-control-sm w-25" id="formFileSm">
            	...
            	<h4 class="text-center"> 상품 문의 </h4>
	          	 ...
	          	 <!-- foreach 기준 -->
		          	 <div class="m-3">
		                ...
		                <div id = "pboard">
		                <div id= "new_p_board"></div> 	
			                <c:forEach var="item" items="${p_board}" step="1"> 
				                <div class="mt-3">
				                	<input type="text" value="${item.articleNo}" class="review_text" style="font-size: 0.8em; color: gray;" readonly>
					                <input type="text" value="${item.user_id}" class="review_text" style="font-size: 0.8em; color: gray;" readonly>
					                <input type="text" value="${item.qna_title}" class="review_text" style="font-size: 0.8em; color: black;" readonly>
					                <input type="text" value="${item.write_date}" class="review_text" style="font-size: 0.8em; color: gray;" readonly>
				                </div>
			                </c:forEach>
		                </div>
	  ...
	  $.ajax({
			...
			success: function(data, textStatus){
				...
				$('#review_data').append(
				                ...
				                +"</div>"
				                +"<div class='mt-3'>"
				                  +"<input type='text' value='"+ jsonInfo.list[i].user_id  +"' class='review_text' style='font-size: 0.8em; color: gray;' readonly>"
  	...
  	function p_board_page(section2,pageNum2,product_num2,chk){  //문의사항 페이징
         	...
         	$.ajax({
				...
				success: function(data, textStatus){
					...
					$('#pboard').append(
					                "<div class='mt-3'>"
					                + "<input type='text' value='"+ jsonInfo.list[i].articleNo  +"'class='review_text' style='font-size: 0.8em; color: gray;' readonly>"
					                + "<input type='text' value='"+ jsonInfo.list[i].user_id  +"'class='review_text' style='font-size: 0.8em; color: gray;' readonly>"
					                + "<input type='text' value='"+ jsonInfo.list[i].qna_title  +"'class='review_text' style='font-size: 0.8em; color: gray;' readonly>"
					                + "<input type='text' value='"+ jsonInfo.list[i].write_date  +"'class='review_text' style='font-size: 0.8em; color: gray;' readonly>"
					               + "</div>" 
							 )
					}
